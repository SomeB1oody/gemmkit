...
| `avx512_test` / `avx512vnni_test` / `avx512bf16_test` | The suite under Intel SDE (`sde64 -spr`) with the AVX-512, VNNI-dot, and BF16-dot kernels pinned — emulated silicon, real code paths |
