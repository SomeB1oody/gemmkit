...
//! `gemmkit_faer`, matching what a downstream crate depending on this adapter alone would reach.
//! A gemmkit type that lands in a public signature without being re-exported fails to compile
//! here, a gap the other test binaries (which import `gemmkit::` directly) cannot catch
