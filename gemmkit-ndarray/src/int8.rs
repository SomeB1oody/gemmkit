...
/// Like [`gemm_i8`] but reuses a caller-owned [`Workspace`]: no per-call allocation, for a
...
/// Like [`gemm_i8_requant`] but reuses a caller-owned [`Workspace`]: no per-call allocation, for
/// a quantized-inference loop
///
/// # Panics
...
/// Like [`gemm_i8_requant_u8`] but reuses a caller-owned [`Workspace`]: no per-call allocation
///
/// # Panics
