...
//! be created and threaded through [`crate::gemm_with`] - its 2nd and later
...
impl Workspace {
    ...
    /// Carve out `a_regions` equal LHS regions plus 1 shared RHS region, each
...
// unit tests for the packing workspace allocator
